...
async function setExpertWinners(){
  const options= {
   ...
   await fetch("https://democracybook.herokuapp.com/experts/expertwinners/" + props.groupId, options)
...
function clearCandidates(){
  ...
  const options= {
   ...
   fetch("https://democracybook.herokuapp.com/experts/clearcandidates/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
if(emails.length>0){
  const options= {
   ...
   fetch("https://democracybook.herokuapp.com/experts/sendelectionnotification/"+ props.groupName +"/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
if(emails.length>0){
  const options= {
   ...
   fetch("https://democracybook.herokuapp.com/experts/sendelectionnotification2/"+ props.groupName +"/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
if(emails.length>0){
  const options= {
   ...
   fetch("https://democracybook.herokuapp.com/experts/sendelectionnotification3/"+ props.groupName +"/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
async function setTime(){
  const options= {
   ...
   await fetch("https://democracybook.herokuapp.com/experts/havingelection/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
async function electionEnd(){
  const options= {
   ...
   await fetch("https://democracybook.herokuapp.com/experts/electionend/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
...
async function secondNotification(){
  const options= {
   ...
   await fetch("https://democracybook.herokuapp.com/experts/secondelectionnotification/" + props.groupId, options)
              .then(response => response.json()).then(json => console.log(json))
}

async function checkTime(){
var datenow=new Date
   await fetch("https://democracybook.herokuapp.com/groups/checktime/" + props.groupId)
    ...
    votes:[auth.isAuthenticated().user._id]
              ...
              async function fetchdata(){
                ...
                const options= {
                  ...
                  await  fetch("https://democracybook.herokuapp.com/experts/addCandidate/", options)
                            .then(response => response.json()).then(json => console.log(json))
...
function fetchCandidateData(){
  fetch("https://democracybook.herokuapp.com/experts/findcandidates/"+props.groupId)
      .then(result => result.json())
      .then(response => {
...
function fetchMembers(){
   fetch("https://democracybook.herokuapp.com/experts/getmembers/"+props.groupId)
   .then(result => result.json())
   .then(response =>
...
await fetch("https://democracybook.herokuapp.com/experts/getgroupdata/"+props.groupId)
.then(result => result.json())
.then(response =>
   ...
   async function giveapproval(){
        ...
        await fetch("https://democracybook.herokuapp.com/experts/approveofcandidate/" + id +"/"+ auth.isAuthenticated().user._id, options
).then(res => {
    console.log(res);
  }).catch(err => {
    console.log(err);
...
console.log(id)
        ...
        await fetch("https://democracybook.herokuapp.com/experts/withdrawapprovalofcandidate/" + id +"/"+ auth.isAuthenticated().user._id, options
) .then(res => {
    console.log(res);
  }).catch(err => {
    console.log(err);
